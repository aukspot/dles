...
<style>
  :global(body) {
    ...
    --color-link-hover: var(--color-link-hover-lightmode);
    --color-link-visited: var(--color-link-visited-lightmode);
    ...
    --color-card-bg-3: var(--color-card-bg-3-lightmode);
    --color-red: var(--color-red-lightmode);
