...
<div class="card">
  ...
  <div class="sponsor-grid p-2">
    ...
    <div class="sponsor-item">
      <a
        href="https://quintalist.com?dles"
        target="_blank"
        class="sponsor-link"
      ...
      >
        <div class="sponsor-card-content">
          <img
            src="/QuintalistLightSmall.jpg"
            alt="Logo for Quintalist, one of our sponsors"
            class="sponsor-logo-img sponsor-logo-light"
          />
          <img
            src="/QuintalistDarkSmall.jpg"
            alt="Logo for Quintalist, one of our sponsors"
...
<style lang="postcss">
  ...
  #sponsor-nibble .sponsor-card-content {
  ...
  #sponsor-quintalist .sponsor-card-content {
